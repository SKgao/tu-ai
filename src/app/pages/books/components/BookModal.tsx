import { Button, Form, Image, Input, InputNumber, Modal, Select, Space, Typography, Upload } from 'antd';
import type { FormInstance, FormProps, UploadProps } from 'antd';
import { UploadOutlined } from '@ant-design/icons';
import type { UploadState } from '@/app/hooks/useUploadState';
import type { BookFormValues, GradeRecord, VersionRecord } from '../types';
...
type BookModalProps = {
  ...
  iconValue?: string;
  onCancel: () => void;
  onSubmit: FormProps<BookFormValues>['onFinish'];
