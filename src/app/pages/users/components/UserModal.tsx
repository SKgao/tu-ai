import { Button, Form, Image, Input, Modal, Select, Space, Typography, Upload } from 'antd';
...
import type { RoleOption, UserFormValues } from '../types';
...
type UserModalProps = {
  ...
  avatarValue?: string;
  onCancel: () => void;
  onSubmit: FormProps<UserFormValues>['onFinish'];
